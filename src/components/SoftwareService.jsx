    ...
    <section className=" text-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Pass Checker Card */}
          <div className="bg-[#1F242C] rounded-4xl p-8 shadow-lg flex flex-col md:flex-row-reverse items-center md:items-start space-y-6 md:space-y-0 md:space-x-reverse md:space-x-8">
            <div className="flex-shrink-0">
